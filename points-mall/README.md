...
| 接口 | 方法 | 路径 | 说明 |
|------|------|------|------|
| 创建商城 | POST | `/points/h5/malls` | 自动生成 mallCode，同时签发 mall API Key |
| 获取商城列表 | GET | `/points/h5/malls` | 支持分页、状态筛选 |
| 获取商城详情 | GET | `/points/h5/malls/{mall_code}` | 商城完整信息 |
| 更新商城 | PUT | `/points/h5/malls/{mall_code}` | 修改名称、域名、Webhook 等 |
| 停用商城 | POST | `/points/h5/malls/{mall_code}/disable` | 停用商城 |
| 签发 API Key | POST | `/points/h5/malls/{mall_code}/api-keys` | 为商城签发新 Key（每商城仅一个） |
| API Key 列表 | GET | `/points/h5/malls/{mall_code}/api-keys` | 查看商城 API Key |
| 重置 Secret | POST | `/points/h5/malls/{mall_code}/api-keys/{id}/reset-secret` | 重新生成 Secret |
| 启用/禁用 Key | POST | `/points/h5/malls/{mall_code}/api-keys/{id}/toggle-status` | 切换 Key 状态 |

**创建商城示例：**

```
POST /points/h5/malls
...
| 接口 | 方法 | 路径 | 说明 |
|------|------|------|------|
| 获取用户信息 | GET | `/points/h5/mall/user/info` | 用户积分等信息 |
| 获取分类列表 | GET | `/points/h5/mall/categories` | 商品分类树 |
| 获取商品列表 | GET | `/points/h5/mall/products` | 支持分页、分类筛选 |
| 获取商品详情 | GET | `/points/h5/mall/products/{productId}` | 含多语言信息 |
| 创建订单 | POST | `/points/h5/mall/orders` | 积分兑换下单 |
| 获取订单列表 | GET | `/points/h5/mall/orders` | 用户订单记录 |
| 获取订单详情 | GET | `/points/h5/mall/orders/{orderId}` | 含物流、卡密信息 |
| 确认收货 | PUT | `/points/h5/mall/orders/{orderId}/confirm` | 完成订单 |

**收货地址管理：**

| 接口 | 方法 | 路径 | 说明 |
|------|------|------|------|
| 获取地址列表 | GET | `/points/h5/mall/addresses` | 用户收货地址 |
| 创建地址 | POST | `/points/h5/mall/addresses` | 新增收货地址 |
| 更新地址 | PUT | `/points/h5/mall/addresses/{id}` | 修改地址信息 |
| 删除地址 | DELETE | `/points/h5/mall/addresses/{id}` | 删除地址 |
| 获取默认地址 | GET | `/points/h5/mall/addresses/default` | 默认收货地址 |
| 设置默认地址 | PUT | `/points/h5/mall/addresses/{id}/default` | 设为默认 |
